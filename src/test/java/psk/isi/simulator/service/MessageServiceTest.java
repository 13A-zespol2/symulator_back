...
class MessageServiceTest {
    ...
    public void ifSavingMessage() throws NoSuchPhoneNumber, NoSmsBalance {
        ...
        SmsHistoryDTO smsHistoryDTO = new SmsHistoryDTO(phoneNumberSenderDto, phoneNumberReceiver.getNumber(), null, null);
        ...
        SmsHistory expectedSms = new SmsHistory(null, phoneNumberSender, phoneNumberReceiver, null, null);
